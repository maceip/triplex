...
the decisions it established. See `docs/FINAL_UNIFICATION.md` for the retirement
...
- `python-agent/` — the retired Python agent (pipeline, ASR, LLM, reasoning,
  ...
  are being ported into `docs/RUNTIME_INVARIANTS.md`; the code is not maintained.
